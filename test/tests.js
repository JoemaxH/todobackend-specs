...
describe('Cross Origin Requests', function() {
  ...
  it('should allow all origins', function() {
    return assert(result, "header").to.have.property([
      "access-control-allow-origin"
    ]).that.equals('*');
...
describe('Create Todo Item', function() {
  ...
  it('should create the item', function() {
    ...
    return assert(item, "body").to.have.property([
      "title"
...
describe('Update Todo Item', function() {
  ...
  it('should have completed set to true after PUT update', function() {
    ...
    //return result.sould.have.property("header.body.completed", true);
    return assert(result, "body").to.have.property([
      'completed'
    ]).that.equals(true);
  });
...
function assert(result, prop) {
  return expect(result).to.eventually.have.property(prop)
